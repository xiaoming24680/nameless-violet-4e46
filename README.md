...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/nameless-violet-4e46
```

A live public deployment of this template is available at [https://nameless-violet-4e46.templates.workers.dev](https://nameless-violet-4e46.templates.workers.dev)
